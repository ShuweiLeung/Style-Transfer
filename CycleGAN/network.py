...
def initialize_generators(input_ngc, output_ngc, ngf, nb, is_cuda):
    G_A = generator(input_ngc, output_ngc, ngf, nb)
    G_B = generator(input_ngc, output_ngc, ngf, nb)
...
def initialize_discriminators(input_ndc, output_ndc, ndf, is_cuda):
    D_A = discriminator(input_ndc, output_ndc, ndf)
    D_B = discriminator(input_ndc, output_ndc, ndf)
